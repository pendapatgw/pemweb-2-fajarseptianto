...
class Matkul extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $matkul3->sks = '3';
        // batas
        $this->load->model('MatkulModel', 'matkul4');
        $matkul4 = new MatkulModel();
        
        $matkul4->matkul = $this->input->post('matkul');;
        $matkul4->dosen = $this->input->post('dosen');;
        $matkul4->waktu = $this->input->post('waktu');;
        $matkul4->sks = $this->input->post('sks');;

        $data = array('matkul' => [$matkul1, $matkul2, $matkul3,$matkul4]);
