                ...
                <div class="col-6 form">
                  <form method="POST" action="result.php">
                    ...
                    <div class="form-group">
                      ...
                      <input id="umur" name="id" type="text" class="form-control" />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div>
                        <input type="number" name="bb" id="berat-badan" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div>
                        <input type="number" name="tb" id="tinggi-badan" class="form-control" />
